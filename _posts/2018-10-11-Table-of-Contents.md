...
I’ve collected notes, conducted research, and began writing this book [CYOD](https://swoicik.com/cyod/), and now have a good idea about what the structure will be. I talked before about the [writing style](https://swoicik.com/2018/writing-style/) of the book, but now I’ll share the actual outline I am working with.

The book will be divided into 5 main themes/sections with short chapters in each. The following outline show all the chapters I have so far, but not necessarily in order. Any input on the structure, order, or content would be greatly appreciated. Reach out on [Twitter](https://twitter.com/swoicik) with any feedback.
